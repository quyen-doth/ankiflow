...
- If the task involves Firestore, read `docs/02-design/DATABASE.md` first; if it involves API routes, read `docs/02-design/API.md` first
...
- If the task touches Firestore schema or API routes, re-read `docs/02-design/DATABASE.md` or `docs/02-design/API.md`
...
- Follow the spec format defined in `docs/03-development/VERIFICATION.md` for verification specs
